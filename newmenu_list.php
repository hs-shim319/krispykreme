<?php 
    ...
    $sql = "select * from event where type='new' order by idx desc;";
...
<head>
    ...
    <title>신메뉴/인기메뉴 | MENU | 크리스피크림도넛</title>
...
<body>
    ...
    <header id="header" class="header">
        ...
        <ul>
            ...
            <li class="depth2"> 
                <a href="#none">신메뉴/인기메뉴<img src="images/step_down_w.png" alt="arrow_img"></a>
                <ul class="depth2_menu">
                    <li><a href="newmenu_list.php"><span class="currently">신메뉴/인기메뉴</span></a></li>
            ...
            <div class="nm_list">
                <ul>
                   <?php
                    ...
                    ?>
                    <li><a href="newmenu.php?idx=<?php echo $array['idx'];?>"><span class="img"><img src="images/<?php echo $array["list_img"];?>" alt=""></span><?php echo $title[0]."]";?><span class="txt"><?php echo $title[1];?></span></a></li>
                    <?php }?>
                </ul>
            </div>
    </main>
