...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/partner_service.css">
...
<body>
    ...
    <header id="header" class="header">
        ...
        <ul>
            ...
            <li class="depth2"> 
                <a href="#none">제휴 서비스<img src="images/step_down_w.png" alt="arrow_img"></a>
                <ul class="depth2_menu">
                    <li><a href="event_list.php">이벤트</a></li>
                    <li><a href="partner_service.php"><span class="currently">제휴 서비스</span></a></li>
                </ul>
            </li>
        </ul>
            </section></div>
    ...
    <main class="content" id="content">
            <div class="title">
                <div class="title_txt">
                <h2>제휴 서비스</h2>
                <p>크리스피 크림 도넛의 결제 및 제휴 서비스 안내드립니다.</p>
                </div>
            </div>
            <div class="p_list">
                <dl>
                    ...
                    <dd class="last"><span class="img"><img src="images/partner_lpay.png" alt=""></span>L.pay<span class="txt">고객센터 : 1899-6300</span><a href="#">자세히 보기 ></a></dd>
                    ...
                    <dd class="last"><span class="img"><img src="images/partner_cashbee.png" alt=""></span>캐시비<span class="txt">고객센터 : 1644-0006</span><a href="#">자세히 보기 ></a></dd>
                    <dd><span class="img"><img src="images/partner_alipay.png" alt=""></span>알리페이<a href="#">쿠폰 조회 ></a></dd>
                </dl>
                <p class="nocecp">*크리스피크림도넛 결제시스템 미이용 특수점 및 일부 점포는 이용에 제한이 있을 수 있습니다.</p>
                <dl>
                    <dt>포인트 적립</dt>
