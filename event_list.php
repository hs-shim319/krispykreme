...
<body>
    ...
    <main id="content" class="content">
            ...
            <div class="event_tab">
                <ul>
                    <li class="currently"><a href="#none">진행 이벤트</a></li>
            ...
            <div class="event_list">
                <ul>
                   <?php
                    ...
                    ?>
                    <li><a href="event.php?idx=<?php echo $array['idx'];?>"><span class="img"><img src="images/<?php echo $array["list_img"];?>" alt=""></span><?php echo $title[0];?><span class="txt"><?php echo $title[1];?></span></a></li>
                    <?php }?>
                </ul>
            </div>
    </main>
