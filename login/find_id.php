...
<body>
    ...
    <div id="content">
        <div class="content_wrap">
            <h2>아이디 찾기</h2>
            <div class="find_id">
                <form name="find_id" action="find_id_ok.php" method="post">
                <fieldset>
                    <legend class="hide_text">아이디찾기</legend>
                    <p><label for="uname"><span class="txt">이름</span></label>
                    <input type="text" name="uname" id="uname"></p>
                    <p><label for="mobile"><span class="txt">휴대폰번호</span></label>
                    <input type="text" name="mobile" id="mobile">
                    <span class="hint">* 가입 시 등록하셨던 휴대폰번호를 기입해 주세요.</span></p>
                    <button type="button" onclick="id_form_check()">확인</button>
                </fieldset>
                </form>
            </div>
        </div>
