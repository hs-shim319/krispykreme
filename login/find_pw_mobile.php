<?php 
    ...
    $sql = "select * from members where uname='$uname' and mobile='$mobile' and uid='$uid';";
//echo $sql; 
//return false;
...
<body>
    ...
    <div id="content">
        <div class="content_wrap">
            <h2>비밀번호 찾기</h2>
            <main class="find_content">
            <p class="t">비밀번호 재설정</p>
              <?php
               if($num==0){
                   echo "일치하는 정보가 없습니다.";
                ?>
                  <div>
                      <a href="#none" onclick="javascript:history.back()">이전으로</a>
                      <a href="login.php">로그인하기</a>
                  </div>
               <?php }else{ ?>
                   <form name="edit_pw_form" action="pw_edit.php" method="post">
                       ...
                       <p><label for="repwd">비밀번호 확인</label><input type="password" name="repwd" id="repwd"></p>
