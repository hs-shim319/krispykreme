...
<head>
    <meta charset="UTF-8">
    <title>아이디/비밀번호 찾기 | 크리스피크림도넛</title>
    <link rel="stylesheet" type="text/css" href="../style/common.css">
    <link rel="stylesheet" type="text/css" href="../style/find_login.css">
    <?php
        if($s_id){ 
        echo "
    ...
    <script type="text/javascript">
        function mobile_check(){
            ...
            document.find_pw_mobile.submit();
        };
        
        function email_check(){
            var euname=document.getElementById("euname");
...
<body>
            ...
            <section class="top_menu">
                <h2 class="hide_text">사용자메뉴</h2>
                    <ul class="top_menu_list">
                        ...
                        <?php
                        if(!$s_id){
                            echo "<li class=\"tm_login\"><a href=\"login.php\">로그인</a></li>";
    ...
    <div id="content">
        <div class="content_wrap">
                ...
                <div class="find_pw">
                     <ul>
                        <li><a href="#none" class="currently">휴대폰번호로 찾기</a></li>
                        <li><a href="#none">이메일주소로 찾기</a></li>
                     </ul>
                     <div class="find_pw_mobile">
                         <form name="find_pw_mobile" action="find_pw_mobile.php" method="post">
                         <fieldset>
                             <legend class="hide_text">휴대폰번호로 비밀번호찾기</legend>
                             <p><label for="uname"><span class="txt">이름</span></label>
                             <input type="text" name="uname" id="uname"></p>
                             <p><label for="uid"><span class="txt">아이디</span></label>
                             <input type="text" name="uid" id="uid"></p>
                             <label for="mobile"><span class="txt">휴대폰번호</span></label>
                             <input type="text" name="mobile" id="mobile">
                             <button type="button" onclick="mobile_check()">확인</button>
                         </fieldset>
                         </form>
                     </div>
                     
                     <div class="find_pw_email">
                         <form name="find_pw_email" action="find_pw_email.php" method="post">
                         <fieldset>
                             <legend class="hide_text">이메일로 비밀번호찾기</legend>
                             <p><label for="euname"><span class="txt">이름</span></label>
                             <input type="text" name="euname" id="euname"></p>
                             <p><label for="euid"><span class="txt">아이디</span></label>
                             <input type="text" name="euid" id="euid"></p>
                             <div class="find_pw_email">
                             ...
                             <button type="button" onclick="email_check()">확인</button>
                         </fieldset>
                         </form>
                     </div>
                </div>
