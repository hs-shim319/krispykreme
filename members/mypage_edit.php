...
<head>
    <meta charset="UTF-8">
    <title>개인정보수정 | 마이페이지 | 크리스피크림도넛</title>
        ...
        <main class="content">
            ...
            <div class="mp_tab">
                <ul>
                    ...
                    <li class="currently"><a href="#none">개인정보수정</a></li>
                    <li><a href="mypage_delete.php">회원탈퇴</a></li>
                </ul>
            </div>
            
            <div class="edit">
                <h3 class="mptitle">개인정보수정</h3>
                <p class="sub_title">크리스피 크림 회원정보를 수정하시면, 이벤트 당첨 및 다양한 혜택을 받으실 수 있습니다.</p>
                <div class="form_wrap">
                    <form name="edit_info" action="mypage_edit_ok.php" method="post">
                        <fieldset class="form_top">
                            ...
                            <p>
                                <label for="pwd"><span class="text">비밀번호</span></label>
                                <input type="password" class="input_text" name="pwd" id="pwd">
                                <span class="hint">영문/숫자 조합으로 10자 이상 입력하세요.</span>
                            </p>
                            <p>
                                <label for="repwd"><span class="text">비밀번호 확인</span></label>
                                <input type="password" class="input_text" name="repwd" id="repwd">
                                <span class="hint">비밀번호를 한번 더 입력하세요.</span>
                            </p>
                            <p>
                                <label for="mobile"><span class="text">휴대폰</span></label>
                                <input type="tel" class="input_text" name="mobile" id="mobile" value="<?php echo $array['mobile'];?>">
                                <span class="hint">'-'를 제외한 숫자만 입력하세요. ex)01012341234</span>
                            </p>
                            <p>
                                <label for="email_id"><span class="text">이메일</span></label>
                                <input type="text" class="input_text_email" name="email_id" id="email_id" value="<?php echo $email[0];?>"> @
                                <input type="text" class="input_text_email" name="email_dns" id="email_dns" value="<?php echo $email[1];?>">
                        ...
                        <fideldset class="form_bottom">
                            ...
                            <p>
                                생년월일<span class="red_txt">(1회 입력 후 재 입력이 불가합니다.)</span>
                                <span class="birth_txt"><?php echo $array["birth"];?></span>
                            </p>
                            <p>
                                <label>어떤 경로로 크리스피 크림을 알게 되셨나요?
                                <select name="visit_route" id="visit_route">
                                    <option value="">선택해주세요.</option>
                                    <option value="1">친구를 통해서</option>
                                    <option value="2">크리스피 크림의 이메일로</option>
                                    <option value="3">웹서핑으로</option>
                            ...
                            <p>
                                ...
                                <select name="fav_dougnut" id="fav_dougnut">
                                    <option value="">선택해주세요.</option>
                                    <option value="1">쿠키 밀크케잌 미니콘</option>
                                    <option value="2">초코 밀크케잌 미니콘</option>
                                    <option value="3">스트로베리 밀크 미니콘</option>
                                    <option value="4">카라멜 밀크 미니콘</option>
                                    <option value="5">오리지널 스트로베리 미니콘</option>
                                </select></label>
                            </p>
                            <p>
                                ...
                                <select name="visit_frequency" id="visit_frequency">
                                    <option value="">선택해주세요.</option>
                                    <option value="1">1주에 한번 이상</option>
                                    <option value="2">1주에 한번</option>
                                    <option value="3">한달에 1~2번</option>
                                    <option value="4">한달에 1번 이하</option>
                                </select></label>
                            </p>
                            <p>
