...
<head>
    ...
    <?php
        ...
        $sql="select * from qna where uid='$s_id' order by idx desc;";
        ...
        <main class="content">
            ...
            <div class="mp_tab">
                <ul>
                    ...
                    <li class="currently"><a href="#none">나의 Q&amp;A</a></li>
            ...
            <div class="myqna_list">
                <h3 class="qnatitle">나의 Q&amp;A</h3>
                <p class="sub_title">더욱 신속하고 친절한 답변을 드리기 위해 노력하겠습니다.</p>
                <div class="qna_table">
                    <p>Total <span class="redtxt"><?php echo $num;?></span></p>
                    
                    <table cellspacing=0>
                        <tr class="list_title">
                            <td class="td1">NO</td>
                            <td class="td2">상담구분</td>
                            <td class="td3">제목</td>
                            <td class="td4">등록일</td>
                            <td class="td4">상태</td>
                        </tr>
                        ...
                        ?>
                            <tr class="list_sub">
                                ...
                                <td><a href="myqna.php?idx=<?php echo $array['idx'];?>"><?php echo $array["title"];?></a></td>
                                <td><?php echo $array["wdate"];?></td>
