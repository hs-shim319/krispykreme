...
<head>
    ...
    <?php
        ...
        $sql="select * from couponbook where uid='$s_id' order by idx desc;";
...
<body>
    ...
    <section id="content">
        <main class="content">
            ...
            <div class="mp_tab">
                <ul>
                    <li class="currently"><a href="#none">쿠폰북</a></li>
            ...
            <div class="coupon">
                <h3 class="mptitle">쿠폰북</h3>
                <p class="sub_title">크리스피 크림에서 드리는 행운의 쿠폰북 입니다. 달콤한 행운까지 가져가세요.</p>
                <div class="coupon_table">
                    ...
                    <dl>
                        <dt>이용안내</dt>
                        <dd>쿠폰은 1회만 출력 가능합니다.</dd>
                        <dd>출력이 가능한상태에도 해당 쿠폰의 사용가능기간이 지난 경우 매장에서 사용이 불가능할 수 있습니다.</dd>
                    </dl>
                </div>
            </div>
        </main>
