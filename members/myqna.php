...
<head>
    <meta charset="UTF-8">
    <title>나의 Q&amp;A | 마이페이지 | 크리스피크림도넛</title>
...
<body>
    ...
    <section id="content">
        <main class="content">
            ...
            <div class="myqna">
                <div class="myqna_tit">
                    <p class="con_title"><?php echo $array["title"];?>
                    <span>등록일 : <?php echo $array["wdate"];?></span></p>
                </div>
                <div class="myqna_con">
                <form name="qna_form" action="qna_ok.php" method="post">
                <div class="form1">
                <p><span class="txt">이름</span><?php echo $array['uname'];?></p>
                <p><span class="txt">연락처</span><?php echo $array['mobile'];?></p>
                <p><span class="txt">Email</span><?php echo $array['email'];?></p>
                </div>
                <div class="form2">
                <p><span class="txt">상담구분</span><?php echo $array["type"];?></p>
                <p class="rel"><span class="txt">내용</span><textarea name="question_content" id="question_content" class="question_content
                " readonly></textarea></p>
                </div>
<!--
                <p class="btn_div">
                    <button type="button" class="submit_btn" onclick="form_check()">수정</button>
                    <button type="button" class="cancel_btn">삭제</button>
                </p>
-->
                </form>
