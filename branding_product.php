...
<head>
    ...
    <title>브랜딩 제품소개 | MENU | 크리스피크림도넛</title>
    <link rel="stylesheet" type="text/css" href="style/common.css">
    <link rel="stylesheet" type="text/css" href="style/branding_product.css">
...
<body>
        ...
        <ul>
            ...
            <li class="depth1">
                ...
                <ul class="depth1_menu">
                    <li><a href="newmenu_list.php"><span class="currently"></span></a></li>
            ...
            <li class="depth2"> 
                <a href="#none">브랜딩 제품소개<img src="images/step_down_w.png" alt="arrow_img"></a>
                <ul class="depth2_menu">
                    ...
                    <li><a href="branding_product.php"><span class="currently">브랜딩 제품소개</span></a></li>
                </ul>
            </li>
        </ul>
    </section></div>
    ...
    <main class="content" id="content">
            <div class="title">
                <div class="title_txt">
                <h2>브랜딩 제품소개</h2>
                <p>크리스피 크림이 담겨있는 다양한 상품을 소개합니다.</p>
                </div>
            </div>
            <div class="mug">
                <h3>MUG</h3>
                <ul>
                    <li><span class="img_brd"><img src="images/mug_white.png" alt="화이트머그컵"></span><p>화이트(WHITE)<span class="price">\ 8,000</span></p></li>
                    <li class="center"><span class="img_brd"><img src="images/mug_gold.png" alt="골드머그컵"></span><p>골드(GOLD)<span class="price">\ 8,000</span></p></li>
                    <li><span class="img_brd"><img src="images/mug_bowtie.png" alt="보타이머그컵"></span><p>보타이(Bowtie)<span class="price">\ 8,000</span></p></li>
                </ul>
            </div><!--mug-->
    </main>
