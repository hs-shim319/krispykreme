                ...
                <ul class="gnb_list">
                        <li class="gnb_menu">
                            ...
                            <ul>
                                ...
                                <li><a href="dougtnuts_list.php">도넛</a></li>
    ...
    <main class="content" id="content">
            ...
            <div class="icecream_menu">
                <ul>
                    ...
                    <li class="m_icecream">
                        <a href="icecream.php?mname=미니%20온탑%20스트로베리">
