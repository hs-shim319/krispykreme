                    ...
                    <ul class="gnb_list">
                        <li class="gnb_menu">
                            ...
                            <ul>
                                ...
                                <li><a href="dougnutlist.php">도넛</a></li>
                        ...
                        <li class="gnb_brand">
                            <a href="dougnuttheater.php">BRAND</a>
                            <ul>
                                <li><a href="dougnuttheater.php">도넛극장</a></li>
                ...
                <ul>
                    ...
                    <li class="depth1">
                        ...
                        <ul class="depth1_menu">
                            ...
                            <li><a href="dougnuttheater.php">BRAND</a></li>
    ...
    <main class="content" id="content">
        ...
        <div class="con">
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $s_array["name"];?></span></p>
                        <p>Tel : <?php echo $s_array["tel"];?></p>
                        <p>영업시간 : <?php echo $s_array["stime"];?></p>
                        <p class="hotnow"><?php if($s_array["hotnow"] != null){echo 'HOT Light Hour : '.$s_array['hotnow'];}?></p>
                        <p class="movie"><?php if($s_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                <div class="store_list">
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $gw_array["name"];?></span></p>
                        <p>Tel : <?php echo $gw_array["tel"];?></p>
                        <p>영업시간 : <?php echo $gw_array["stime"];?></p>
                        <p class="hotnow"><?php if($gw_array["hotnow"] != null){echo 'HOT Light Hour : '.$gw_array['hotnow'];}?></p>
                        <p class="movie"><?php if($gw_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                </div>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $gg_array["name"];?></span></p>
                        <p>Tel : <?php echo $gg_array["tel"];?></p>
                        <p>영업시간 : <?php echo $gg_array["stime"];?></p>
                        <p class="hotnow"><?php if($gg_array["hotnow"] != null){echo 'HOT Light Hour : '.$gg_array['hotnow'];}?></p>
                        <p class="movie"><?php if($gg_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $kn_array["name"];?></span></p>
                        <p>Tel : <?php echo $kn_array["tel"];?></p>
                        <p>영업시간 : <?php echo $kn_array["stime"];?></p>
                        <p class="hotnow"><?php if($kn_array["hotnow"] != null){echo 'HOT Light Hour : '.$kn_array['hotnow'];}?></p>
                        <p class="movie"><?php if($kn_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $kb_array["name"];?></span></p>
                        <p>Tel : <?php echo $kb_array["tel"];?></p>
                        <p>영업시간 : <?php echo $kb_array["stime"];?></p>
                        <p class="hotnow"><?php if($kb_array["hotnow"] != null){echo 'HOT Light Hour : '.$kb_array['hotnow'];}?></p>
                        <p class="movie"><?php if($kb_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $gj_array["name"];?></span></p>
                        <p>Tel : <?php echo $gj_array["tel"];?></p>
                        <p>영업시간 : <?php echo $gj_array["stime"];?></p>
                        <p class="hotnow"><?php if($gj_array["hotnow"] != null){echo 'HOT Light Hour : '.$gj_array['hotnow'];}?></p>
                        <p class="movie"><?php if($gj_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $dg_array["name"];?></span></p>
                        <p>Tel : <?php echo $dg_array["tel"];?></p>
                        <p>영업시간 : <?php echo $dg_array["stime"];?></p>
                        <p class="hotnow"><?php if($dg_array["hotnow"] != null){echo 'HOT Light Hour : '.$dg_array['hotnow'];}?></p>
                        <p class="movie"><?php if($dg_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $dj_array["name"];?></span></p>
                        <p>Tel : <?php echo $dj_array["tel"];?></p>
                        <p>영업시간 : <?php echo $dj_array["stime"];?></p>
                        <p class="hotnow"><?php if($dj_array["hotnow"] != null){echo 'HOT Light Hour : '.$dj_array['hotnow'];}?></p>
                        <p class="movie"><?php if($dj_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            <?php };//cdj==y
                if($cbs=='y'){
                    $bsql="select * from store where city='부산' and name like '%$sname%';";
                    $bresult=mysqli_query($con,$bsql);
                    $bnum=mysqli_num_rows($bresult);
            ?>
            <div class="store_con">
                <p class="store_num"><span class="redtxt">부산</span>지역 <span class="redtxt"><?php echo $bnum;?></span>개의 매장</p>
                <div class="store_list">
                    <!--전체 매장정보-->
                    <?php 
                        for($i=1;$i<=$bnum;$i++){ 
                        $barray=mysqli_fetch_array($bresult);
            ?>
                    <a href="#none">
                        <img src="images/store/<?php echo $barray['img'];?>" alt="<?php echo $barray["name"];?>">
                        <p class="store_name"><?php echo $barray["name"];?></p>
                        <p class="hotnow">HOT Light Hour : <?php echo $barray['hotnow'];?></p>
                        <p class="movie"><?php if($barray['movie']=='y'){echo "도넛극장";}?></p>
                        <p>Tel.<?php echo $barray["tel"];?></p>
                        <p><?php echo $barray["stime"];?></p>
                    </a>
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $barray["name"];?></span></p>
                        <p>Tel : <?php echo $barray["tel"];?></p>
                        <p>영업시간 : <?php echo $barray["stime"];?></p>
                        <p class="hotnow"><?php if($barray["hotnow"] != null){echo 'HOT Light Hour : '.$barray['hotnow'];}?></p>
                        <p class="movie"><?php if($barray['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            <?php };//cbs==y
                if($cus=='y'){
                    $usql="select * from store where city='울산' and name like '%$sname%';";
                    $uresult=mysqli_query($con,$usql);
                    $unum=mysqli_num_rows($uresult);
            ?>
            <div class="store_con">
                <p class="store_num"><span class="redtxt">울산</span>지역 <span class="redtxt"><?php echo $unum;?></span>개의 매장</p>
                <div class="store_list">
                    <!--전체 매장정보-->
                    <?php 
                        for($i=1;$i<=$unum;$i++){ 
                        $uarray=mysqli_fetch_array($uresult);
            ?>
                    <a href="#none">
                        <img src="images/store/<?php echo $uarray['img'];?>" alt="<?php echo $uarray["name"];?>">
                        <p class="store_name"><?php echo $uarray["name"];?></p>
                        <p class="hotnow">HOT Light Hour : <?php echo $uarray['hotnow'];?></p>
                        <p class="movie"><?php if($uarray['movie']=='y'){echo "도넛극장";}?></p>
                        <p>Tel.<?php echo $uarray["tel"];?></p>
                        <p><?php echo $uarray["stime"];?></p>
                    </a>
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $uarray["name"];?></span></p>
                        <p>Tel : <?php echo $uarray["tel"];?></p>
                        <p>영업시간 : <?php echo $uarray["stime"];?></p>
                        <p class="hotnow"><?php if($uarray["hotnow"] != null){echo 'HOT Light Hour : '.$uarray['hotnow'];}?></p>
                        <p class="movie"><?php if($uarray['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $ic_array["name"];?></span></p>
                        <p>Tel : <?php echo $ic_array["tel"];?></p>
                        <p>영업시간 : <?php echo $ic_array["stime"];?></p>
                        <p class="hotnow"><?php if($ic_array["hotnow"] != null){echo 'HOT Light Hour : '.$ic_array['hotnow'];}?></p>
                        <p class="movie"><?php if($ic_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $jn_array["name"];?></span></p>
                        <p>Tel : <?php echo $jn_array["tel"];?></p>
                        <p>영업시간 : <?php echo $jn_array["stime"];?></p>
                        <p class="hotnow"><?php if($jn_array["hotnow"] != null){echo 'HOT Light Hour : '.$jn_array['hotnow'];}?></p>
                        <p class="movie"><?php if($jn_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $jb_array["name"];?></span></p>
                        <p>Tel : <?php echo $jb_array["tel"];?></p>
                        <p>영업시간 : <?php echo $jb_array["stime"];?></p>
                        <p class="hotnow"><?php if($jb_array["hotnow"] != null){echo 'HOT Light Hour : '.$jb_array['hotnow'];}?></p>
                        <p class="movie"><?php if($jb_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $jj_array["name"];?></span></p>
                        <p>Tel : <?php echo $jj_array["tel"];?></p>
                        <p>영업시간 : <?php echo $jj_array["stime"];?></p>
                        <p class="hotnow"><?php if($jj_array["hotnow"] != null){echo 'HOT Light Hour : '.$jj_array['hotnow'];}?></p>
                        <p class="movie"><?php if($jj_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $cn_array["name"];?></span></p>
                        <p>Tel : <?php echo $cn_array["tel"];?></p>
                        <p>영업시간 : <?php echo $cn_array["stime"];?></p>
                        <p class="hotnow"><?php if($cn_array["hotnow"] != null){echo 'HOT Light Hour : '.$cn_array['hotnow'];}?></p>
                        <p class="movie"><?php if($cn_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
            ...
            ?>
                    ...
                    <div class="store_detail">
                        <p><span class="bold"><?php echo $cb_array["name"];?></span></p>
                        <p>Tel : <?php echo $cb_array["tel"];?></p>
                        <p>영업시간 : <?php echo $cb_array["stime"];?></p>
                        <p class="hotnow"><?php if($cb_array["hotnow"] != null){echo 'HOT Light Hour : '.$cb_array['hotnow'];}?></p>
                        <p class="movie"><?php if($cb_array['movie']=='y'){echo "도넛극장";}?></p>
                        <a href="#none">닫기</a>
                    </div>
                    <?php } ?>
