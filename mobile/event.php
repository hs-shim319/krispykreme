...
<body>
    ...
    <main id="content" class="content">
            <div class="event_con">
                <p class="con_title"><?php echo $array["title"];?></p>
                <p class="date">
                <?php if($array["sdate"]=='0000-00-00'){echo "상시";}
                    else{echo $array["sdate"]."~".$array["fdate"];}?>
                </p>
                <p class="con_img"><img src="images/<?php echo $array['img'];?>" alt="">
                <a href="event_list.php">List</a>
                </p>
            </div>
    </main>
