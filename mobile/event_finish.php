...
<body>
    ...
    <section class="location_bar">
        <p><a href="#none">종료 이벤트</a></p>
           <ul>
              <li><a href="event_list.php">진행 이벤트</a></li>
              <li><span class="currently"><a href="#none">종료 이벤트</a></span></li>
            ...
            <div class="ev_list">
                <ul>
                   <?php
                    ...
                    ?>
                    <li>
                        <span class="evf_img"><img src="images/<?php echo $array["list_img"];?>" alt=""></span>
                        <p><?php echo $title[0];?><span class="txt"><?php echo $title[1];?></span>
                        <span class="date"><?php echo $array['sdate'].'~'.$array['fdate'];?></span>
                        </p>
                    </li>
                    <?php }?>
                </ul>
