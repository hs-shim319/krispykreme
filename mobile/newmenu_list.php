...
<body>
    ...
    <section class="location_bar">
        <p><a href="#none">신메뉴/인기메뉴</a></p>
           <ul>
              <li><span class="currently"><a href="">신메뉴/인기메뉴</a></span></li>
              <li><a href="dom.php">이 달의 메뉴</a></li>
              <li><a href="dougnuts_list.php">도넛</a></li>
              <li><a href="coffee_list.php">커피/음료</a></li>
              <li><a href="icecream_list.php">아이스크림/프로즌</a></li>
            ...
            <div class="nm_list">
                <ul>
                   <?php
                    ...
                    ?>
                    <li><a href="newmenu.php?idx=<?php echo $array['idx'];?>"><span class="img"><img src="images/<?php echo $array['list_img'];?>" alt=""></span><span class="txt_1"><?php echo $title[0]."]";?></span><span class="txt_2"><?php echo $title[1];?></span></a></li>
                    <?php }?>
                </ul>
            </div>
    </main>
