<?php 
    ...
    $sql = "select * from event where type='winner' order by idx desc;";
...
<head>
    <meta charset="UTF-8">
    <title>당첨자 발표 | EVENT | 크리스피크림도넛</title>
...
<body>
    ...
    <section class="location_bar">
        <p><a href="#none">당첨자 발표</a></p>
           <ul>
              <li><a href="event_list.php">진행 이벤트</a></li>
              <li><a href="event_finish.php">종료 이벤트</a></li>
              <li><span class="currently"><a href="#none">당첨자발표</a></span></li>
              <li><a href="partner_service.php">제휴 서비스</a></li>
           </ul>
    </section>
    ...
    <main id="content" class="content">
            ...
            <table>
                ...
                ?>
                    <tr>
                        <td colspan=2 class="emptytd">등록된 당첨자발표가 없습니다.</td>
                    </tr>
                <?php
                }else{
                    for($i=1;$i<=$num;$i++){
                ...
                ?>
                    <tr>
                        <td class="tdidx"><?php echo $num-$i+1;?></td>
                        <td><a href="winner.php?idx=<?php echo $array['idx'];?>"><?php echo $array["title"];?></a></td>
                    </tr>
                <?php }} ?>
            </table>
            </div>
