<?php 
    ...
    $today = date("Ymd");
    $sql = "select * from event where type='event' and (fdate>=$today or fdate is null)order by sdate desc;";
...
<head>
    ...
    <title>진행 이벤트 | EVENT | 크리스피크림도넛</title>
...
<body>
    ...
    <section class="location_bar">
        <p><a href="#none">진행 이벤트</a></p>
           <ul>
              <li><span class="currently"><a href="#none">진행 이벤트</a></span></li>
              <li><a href="event_finish.php">종료 이벤트</a></li>
              <li><a href="event_winner.php">당첨자발표</a></li>
              <li><a href="partner_service.php">제휴 서비스</a></li>
           </ul>
    </section>
                   ...
                   <?php
                    ...
                    <li>
                        <a href="event.php?idx=<?php echo $array['idx'];?>">
                            <span class="img"><img src="images/<?php echo $array["list_img"];?>" alt=""></span>
                            <p><?php echo $title[0];?><span class="txt"><?php echo $title[1];?></span>
                            <span class="date"><?php if($array["sdate"]=='0000-00-00'){echo "상시";}
                            else{echo $array["sdate"]."~".$array["fdate"];}?></span>
                            </p>
                        </a>
                    </li>
                    <?php }?>
