...
<body>
    ...
    <header id="header" class="header">
        <div class="header_bottom_wrap">
            <div class="header_bottom">
                ...
                <h2 class="title">L.POINT 등급 확인 안내</h2>
                <nav class="gnb">
                    <h2>메인메뉴</h2>
    ...
    <main id="content" class="lpoint">
        <h3 class="hide_text">L.POINT 회원 등급 안내</h3>
        <p>우수회원 산정 기준 : <span class="r">연 4회 이상 L.POINT 적립</span></p>
    ...
    <div class="footer_wrap">
        <footer id="footer">
            ...
            <ul class="footer_term_wrap">
                <li class="footer_term"><a href="https://www.lottegrs.com/main.jsp" target="_blank">회사소개</a></li>
                <li class="footer_term"><a href="#">채용정보</a></li>
                <li class="footer_term"><a href="#">이용약관</a></li>
                <li class="footer_term font_b"><a href="#"><span>개인정보처리방침</span></a></li>
