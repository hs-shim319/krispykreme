...
<head>
    <meta charset="UTF-8">
    <title>공지사항 | ABOUT | 크리스피크림도넛</title>
...
<body>
    ...
    <section class="location_bar">
        <p><a href="#none">공지사항</a></p>
           <ul>
              <li><span class="currently"><a href="#none">공지사항</a></span></li>
              <li><a href="brand.php">브랜드</a></li>
              <li><a href="store_merchants.php">가맹점모집</a></li>
           </ul>
    </section>
    ...
    <main id="content" class="content">
            ...
            <table>
                ...
                ?>
                    <tr class="list_con">
                        <td colspan=3 class="emptytd">등록된 공지사항이 없습니다.</td>
                    </tr>
                <?php
                }else{
                    for($i=1;$i<=$num;$i++){
                ...
                ?>
                    <tr class="list_con">
                        ...
                        <td><a href="notice.php?idx=<?php echo $array['idx'];?>"><?php echo $array["title"];?></a></td>
                    </tr>
                <?php }} ?>
            </table>
            </div>
