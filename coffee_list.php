...
<body>
    ...
    <header id="header" class="header">
        ...
        <ul>
            ...
            <li class="depth2"> 
                <a href="#none">커피/음료<img src="images/step_down_w.png" alt="arrow_img"></a>
                <ul class="depth2_menu">
                    <li><a href="newmenu_list.php">신메뉴/인기메뉴</a></li>
                    <li><a href="dom.php">이달의 메뉴</a></li>
                    <li><a href="dougnuts_list.php">도넛</a></li>
                    <li><a href="coffee_list.php"><span class="currently">커피/음료</span></a></li>
                    <li><a href="icecream_list.php">아이스크림/프로즌</a></li>
    ...
    <main class="content" id="content">
            ...
            <div class="bev_menu">
                <ul>
                    <li class="b_ade">
                        <a href="coffee.php?mname=트로피컬%20스파클링%20펀치">
                    ...
                    <li class="b_ade">
                        <a href="coffee.php?mname=믹스베리%20스파클링%20펀치">
