...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/store_merchants.css">
...
<body>
    ...
    <header id="header" class="header">
        ...
        <ul>
            ...
            <li class="depth2"> 
                <a href="#none">가맹점모집<img src="images/step_down_w.png" alt="arrow_img"></a>
    ...
    <main class="content" id="content">
            <div class="title">
                <div class="title_txt">
                <h2>가맹점모집</h2>
                <p>성공을 위한 확실한 투자, 크리스피크림과 함께하세요!</p>
                </div>
            </div>
            <div class="merchants">
                <h3>가맹금, 교육비</h3>
