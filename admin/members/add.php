    ...
    <div id="content" class="content">
            <main class="admin_content">
                ...
                <form name="add_form" action="add_ok.php" method="post">
                    <p><label for="uname">이름</label> <input type="text" name="uname" id="uname"></p>
                    <p><label for="uid">아이디</label> <input type="text" name="uid" id="uid"></p>
                    <p><label for="pwd">비밀번호</label> <input type="password" name="pwd" id="pwd"></p>
                    <p><label for="mobile">휴대폰번호</label> <input type="text" name="mobile" id="mobile"></p>
                    <p><label for="email_id">이메일</label> <input type="text" name="email_id" id="email_id" class="email"> @ <input type="text" name="email_dns" id="email_dns" class="email">
                    ...
                    <p><label for="birth">생년월일</label> <input type="text" name="birth" id="birth"></p>
                    <div class="btn">
