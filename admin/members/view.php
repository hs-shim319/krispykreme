...
<body>
    ...
    <div id="content" class="content">
            <main class="admin_content">
                ...
                <div class="view">
                    <p><span class="view_txt">이름</span><span class="view_input"><?php echo $array["uname"];?></span></p>
                    <p><span class="view_txt">아이디</span><span class="view_input"><?php echo $array["uid"];?></span></p>
                    <p><span class="view_txt">비밀번호</span><span class="view_input"><?php echo $array["pwd"];?></span></p>
                    <p><span class="view_txt">휴대폰번호</span><span class="view_input"><?php echo $array["mobile"];?></span></p>
                    <p><span class="view_txt">이메일</span><span class="view_input"><?php echo $array["email"];?></span></p>
                    <p><span class="view_txt">생년월일</span><span class="view_input"><?php echo $array["birth"];?></span></p>
                    <div class="btn">
