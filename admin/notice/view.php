    ...
    <div id="content" class="content">
            <main class="admin_content">
                ...
                <ul>
                    ...
                    <li class="currently"><a href="../notice/list.php">공지사항관리</a></li>
                    <li><a href="../event/list.php">이벤트관리</a></li>
                </ul>
                </div>
                <div class="view">
                    <p><span class="view_txt">제목</span> <span class="view_input"><?php echo $array['title'];?></span></p>
                    <p><span class="view_txt">내용</span><textarea readonly name="content" id="content"><?php echo $array['content'];?></textarea></p>
                    <div class="btn">
