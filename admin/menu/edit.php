    ...
    <div id="content" class="content">
            <main class="admin_content">
                ...
                <form name="add_form" action="edit_ok.php" method="post">
                    ...
                    <p><label for="mtype">메뉴타입</label> <input type="text" name="mtype" id="mtype" value="<?php echo $array['mtype'];?>"></p>
                    <p><label for="mname">이름</label> <input type="text" name="mname" id="mname" value="<?php echo $array['mname'];?>"></p>
                    <p><label for="engname">영어이름</label> <input type="text" name="engname" id="engname" value="<?php echo $array['engname'];?>"></p>
                    <p><label for="price">가격</label> <input type="text" name="price" id="price" value="<?php echo $array['price'];?>"></p>
                    <p><label for="portionsize">1회 제공량</label> <input type="text" name="portionsize" id="portionsize" value="<?php echo $array['portionsize'];?>"></p>
                    <p><label for="kcal">칼로리</label> <input type="text" name="kcal" id="kcal" value="<?php echo $array['kcal'];?>"></p>
                    <p><label for="na">나트륨</label> <input type="text" name="na" id="na" value="<?php echo $array['na'];?>"></p>
                    <p><label for="sugar">당류</label> <input type="text" name="sugar" id="sugar" value="<?php echo $array['sugar'];?>"></p>
                    <p><label for="fat">지방</label> <input type="text" name="fat" id="fat" value="<?php echo $array['fat'];?>"></p>
                    <p><label for="protein">단백질</label> <input type="text" name="protein" id="protein" value="<?php echo $array['protein'];?>"></p>
                    <p><label for="size">사이즈</label> <input type="text" name="size" id="size" value="<?php echo $array['size'];?>"></p>
                    <p><label for="img">이미지</label> <input type="text" name="img" id="img" value="<?php echo $array['img'];?>"></p>
                    <div class="btn">
