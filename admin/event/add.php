<?php include "../inc/adminsession.php"; ?>
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <title>신메뉴관리 | 관리자페이지 | 크리스피크림도넛</title>
    ...
    <div id="content" class="content">
            <main class="admin_content">
                ...
                <form name="add_form" action="add_ok.php" method="post">
                    <p><label for="title">제목</label> <input type="text" name="title" id="title"></p>
                    <p><label for="list_img">리스트이미지명</label> <input type="text" name="list_img" id="list_img" placeholder=".png"></p>
                    <p><label for="img">컨텐트이미지명</label> <input type="text" name="img" id="img" placeholder=".png"></p>
                    <p><label for="sdate">시작일</label> <input type="text" name="sdate" id="sdate"></p>
                    <p><label for="fdate">종료일</label> <input type="text" name="fdate" id="fdate"></p>
                    <div class="btn">
