...
<body>
    ...
    <main id="content" class="content">
            <div class="sitemap_title">
                <div class="title_txt">
                    <h2>사이트맵</h2>
                    <p>전체 서비스를 한눈에 확인하세요.</p>
                </div>
            </div>
            <div class="sitemap_con">
            <dl>
                <dt>MENU</dt>
                <dd><a href="newmenu_list.php">신메뉴/인기메뉴</a></dd>
                <dd><a href="dom.php">이 달의 메뉴</a></dd>
                <dd><a href="dougnuts_list.php">도넛</a></dd>
                <dd><a href="coffee_list.php">커피/음료</a></dd>
                <dd><a href="icecream_list.php">아이스크림/프로즌</a></dd>
                <dd><a href="branding_product.php">브랜딩 제품 소개</a></dd>
            </dl>
            <dl>    
                <dt>STORE</dt>
                <dd><a href="homeservice.php">홈 서비스</a></dd>
                <dd><a href="find_store.php">매장찾기</a></dd>
                <dd><a href="store_merchants.php">가맹점모집</a></dd>
            </dl>
            <dl>    
                <dt>EVENT</dt>
                <dd><a href="event_list.php">이벤트</a>
                <ul>
                    <li><a href="event_list.php">진행 이벤트</a></li>
                    <li><a href="event_finish.php">종료 이벤트</a></li>
                    <li><a href="event_winner.php">당첨자 발표</a></li>
                </ul></dd>
                <dd><a href="partner_service.php">제휴 서비스</a></dd>
            </dl>
            <dl>    
                <dt>BRAND</dt>
                <dd><a href="dougnuts_theater.php">도넛극장</a></dd>
                <dd><a href="brand_story.php">브랜드 스토리</a><ul>
                    <li><a href="brand_story.php">BRAND STORY</a></li>
                    <li><a href="brand_story.php">HISTORY</a></li>
                    <li><a href="brand_story.php">SHARE THE LOVE</a></li>                    
                </ul></dd>
                <dd><a href="voucher.php">상품권 구입 안내</a></dd>
            </dl>
            <dl>    
                <dt>CUSTOMER</dt>
                <dd><a href="notice_list.php">공지사항</a></dd>
                <dd><a href="faq.php">고객의 소리</a><ul>
                    <li><a href="faq.php">FAQ</a></li>
                    <li><a href="customer_question.php">1:1 고객문의</a></li>
                </ul></dd>
                <dd><a href="https://www.mykkdd.com/kor?AspxAutoDetectCookieSupport=1">설문조사</a></dd>
            </dl>
            </div>
    </main>
